...
class PlaywrightComputer(BaseComputer):
  ...
  async def current_state(self, ss_return_type: Literal["png_bytes", "base64"] = "base64") -> ComputerState:
    await self._page.wait_for_load_state()
    ...
    return ComputerState(
        screenshot=screenshot_bytes if ss_return_type=="png_bytes" else base64.b64encode(screenshot_bytes).decode("utf-8"), 
        url=self._page.url
        )
